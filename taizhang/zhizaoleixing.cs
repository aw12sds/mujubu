...
{
    public partial class zhizaoleixing : DevExpress.XtraEditors.XtraForm
    {
        public string id;
        public string yonghu;
        public string 工作令号;
        DataTable 人员;
        public zhizaoleixing(string id)
        {
            InitializeComponent();
            this.id = id;
        }
        ...
        private void zhizaoleixing_Load(object sender, EventArgs e)
        {
